...
/*PARA MARCO <3...y hugo
Duda con contraseña y check
	De 8 a 12 dígitos contener una mayúscula, minúsculas, dígitos y un carácter especial (*,$,&).
Duda en chek lapso
	Se calcula como la fecha final menos la fecha inicial y debe ser menor a 40
Duda en todos los calculados checar 
	*CS MER/Version3/Copia de reporte
*/